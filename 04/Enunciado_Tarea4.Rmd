...
Respecto a los intervalos de credibilidad, un problema de ocupar dichos intervalos es que, para distribuciones poco simétricas, no son óptimos porque son simétrico respecto a su centro, el peso *de cada lado* es equivalente. En ese sentido, los intervalos HDPI sirven para distribuciones no simétricas.
...
Respecto al último histrograma, nótese que el modelo se ajusta bien a los datos ya que la distribución de las predicciones incluye la observación real como resultado central y probable. Se puede observar que el valor MAP calculado sobre la grid approximation es central en los histogramas calculados.
